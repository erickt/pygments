...
__all__ = ['CLexer', 'CppLexer', 'DLexer', 'DelphiLexer', 'JavaLexer', 'ScalaLexer',
           ...
           'GLShaderLexer', 'PrologLexer', 'CythonLexer', 'ValaLexer', 'FelixLexer']
...
class FelixLexer(RegexLexer):
    ...
    tokens = {
        'root': [
            ...
            # Keywords
            (r'(axiom|ctor|fun|gen|proc|reduce|union)\b', Keyword, 'funcname'),
        ...
        'macro': [
            ...
            (r'(import|include)(\s+)(<[^>]*?>)', bygroups(Comment.Preproc, Text, String), '#pop'),
            (r'(import|include)(\s+)("[^"]*?")', bygroups(Comment.Preproc, Text, String), '#pop'),
            (r"(import|include)(\s+)('[^']*?')", bygroups(Comment.Preproc, Text, String), '#pop'),
            (r'[^/\n]+', Comment.Preproc),
            ##(r'/[*](.|\n)*?[*]/', Comment),
